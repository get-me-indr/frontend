...
constructor(){
  ...
  success(pos) {
    ...
    let self = this;
    fetch('https://get-me-indr.herokuapp.com/discovery?geoPoint=9xj3kurfm&artists=Colorado%20Rockies%20vs.%20Cincinnati%20Reds,Madonna,The%20Cranberries,Michael%20Jackson',
   {mode: 'no-cors' })
